...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="crosscompile_opts_headers-only idl libraries +secure tools"
RESTRICT="strip"
...
src_install() {
	if use amd64; then
		dosym lib /usr/${CTARGET}/lib64
	else
		dosym lib /usr/${CTARGET}/lib32
	fi
	default
